...
namespace PCE_StarterProject
{
    ...
    public class RecursiveMethods
    {
        ...
        {
            Fib_Array_Helper(array, 0); //pass array, start at 0
        }

        private int[] Fib_Array_Helper(int[] array, int currentIteration)
        {
            //final answer
            ...
            //populate the array with fib values
            else
            {
                //set base cases
                ...
                //all other conditions, calcuate via regular fib value
                else
                {
                    array[currentIteration] = array[currentIteration - 1] + array[currentIteration - 2];
                }
                currentIteration++;
                return Fib_Array_Helper(array, currentIteration);
            }
        }
    }
    ...
    public class MyLinkedList
    {
        ...
        public void RecursivelyPrintBackward()
        {
            ...
            //    return;
            //}
            //LinkedListNode current = m_first;
            //do
            //{
            //    Console.WriteLine(current.m_data);
